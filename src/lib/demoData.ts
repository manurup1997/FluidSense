...
import type {
  PatientProfile, FluidProfile, FluidEvent, WeightEvent, SavedContainer, QuickButtonPref,
} from '../types';
...
// --- Patient IDs -------------------------------------------------------------
export const PATIENT_A_ID = 'patient-a-aki';
export const PATIENT_B_ID = 'patient-b-hf';
export const PATIENT_HOME_ID = 'patient-home';

// --- Containers ---------------------------------------------------------------
const blueMug: SavedContainer = { id: 'c-blue-mug', name: 'Blue mug', fullVolumeMl: 300 };
const hospitalCup: SavedContainer = { id: 'c-hospital-cup', name: 'Hospital cup', fullVolumeMl: 180, isStandard: true };
const waterGlass: SavedContainer = { id: 'c-water-glass', name: 'Water glass', fullVolumeMl: 250, isStandard: true };
const personalBottle: SavedContainer = { id: 'c-personal-bottle', name: 'Personal bottle', fullVolumeMl: 500 };
const soupBowl: SavedContainer = { id: 'c-soup-bowl', name: 'Soup bowl', fullVolumeMl: 350, isStandard: true };

// --- Fluid profiles -------------------------------------------------------------
export const fluidProfiles: FluidProfile[] = [
  {
    id: 'fp-blue-mug-coffee', name: 'Blue mug coffee', category: 'coffee', containerId: blueMug.id,
  ...
  {
    id: 'fp-nutriboost', name: 'NutriBoost Vanilla', brand: 'NutriBoost (fictional)', category: 'nutritional_drink',
  ...
  {
    id: 'fp-soup', name: 'Homemade soup', category: 'soup', containerId: soupBowl.id, containerVolumeMl: 350,
    usualServingFraction: 0.75, waterContentPercent: 90, waterContentSource: 'User-entered estimate',
    verified: false, favourite: true,
  },
  {
    id: 'fp-water-glass', name: 'Water', category: 'water', containerId: waterGlass.id, containerVolumeMl: 250,
    usualServingFraction: 1, verified: true, favourite: true,
  },
  {
    id: 'fp-personal-bottle-water', name: 'Personal bottle water', category: 'water', containerId: personalBottle.id,
    containerVolumeMl: 500, usualServingFraction: 1, verified: true, favourite: true,
  },
  {
    id: 'fp-hospital-tea', name: 'Hospital tea', category: 'tea', containerId: hospitalCup.id, containerVolumeMl: 180,
...
export const patients: PatientProfile[] = [
  {
    ...
    monitoringPeriod: 'rolling_24h',
    units: 'mL',
    favouriteFluidIds: ['fp-hospital-tea', 'fp-water-glass'],
  ...
  },
  {
    ...
    monitoringPeriod: 'rolling_24h',
    units: 'mL',
    favouriteFluidIds: ['fp-hospital-tea'],
    containers: [hospitalCup, waterGlass],
    quickButtons: quickButtons(),
    dailyWeightEnabled: true,
  ...
  },
  {
    ...
    monitoringPeriod: 'rolling_24h',
    units: 'mL',
    favouriteFluidIds: ['fp-blue-mug-coffee', 'fp-nutriboost', 'fp-soup'],
...
// ===== Patient A — AKI, LOW reliability (last 24h) ===============================
{
  ...
  events.push(
    mkEvent({ patientId: p, direction: 'intake', category: 'tea', subtype: 'hospital_tea', amountMl: 180, unit: 'mL', status: 'measured', containerId: hospitalCup.id, containerFraction: 1, fluidProfileId: 'fp-hospital-tea', waterContentPercent: 97, estimatedWaterContributionMl: 175, eventTime: at(22), enteredBy: 'Staff Nurse J. Patel', inputMethod: 'tap' }),
...
// ===== Home Demo User — MODERATE reliability =======================================
{
  ...
  events.push(
    mkEvent({ patientId: p, direction: 'intake', category: 'coffee', amountMl: 150, unit: 'mL', status: 'container_estimated', containerId: blueMug.id, containerFraction: 0.5, fluidProfileId: 'fp-blue-mug-coffee', waterContentPercent: 98, estimatedWaterContributionMl: 147, eventTime: at(23), enteredBy: 'You', inputMethod: 'tap', note: 'I just drank half a cup of coffee.' }),
    ...
    mkEvent({ patientId: p, direction: 'intake', category: 'soup', amountMl: 263, unit: 'mL', status: 'container_estimated', containerId: soupBowl.id, containerFraction: 0.75, fluidProfileId: 'fp-soup', waterContentPercent: 90, estimatedWaterContributionMl: 237, eventTime: at(14), enteredBy: 'You', inputMethod: 'manual' }),
    ...
    mkEvent({ patientId: p, direction: 'intake', category: 'nutritional_drink', amountMl: 200, unit: 'mL', status: 'measured', fluidProfileId: 'fp-nutriboost', waterContentPercent: 78, estimatedWaterContributionMl: 156, eventTime: at(9), enteredBy: 'You', inputMethod: 'tap' }),
...
export const demoWeightEvents = weightEvents;
export const allContainers: SavedContainer[] = [blueMug, hospitalCup, waterGlass, personalBottle, soupBowl];
